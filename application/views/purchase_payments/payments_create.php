...
<span class="label label-info pull-right"><?php echo $purchase->reference; ?></span>
<div class="text-muted page-desc"><?php echo $page_subheading;?></div>
<hr />
<?php echo form_open("purchase_payments/create?id=".$purchase->id, array('class' => 'form-horizontals'));?>
<?php echo form_hidden('payment[purchase_id]', $purchase->id); ?>
<div class="row">
  <div class="col-md-5 col-md-offset-1">
    ...
    <div class="form-group required">
      ...
      <div class="input-group">
        <input type="number" step="any" min="0" value="<?php echo set_value("payment[amount]", $purchase->total_due) ?>" name="payment[amount]" class="form-control" id="amount" />
        <span class="input-group-addon" ><?php echo $this->settings_model->getFormattedCurrencies($purchase->currency)->symbol_native ?></span>
      </div>
    </div>
  </div>
  <div class="col-md-5">
