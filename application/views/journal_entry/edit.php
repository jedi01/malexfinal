...
$doc_name = array(
  'name'         => 'doc_name',
  'id'           => 'doc_name',
  'value'        => set_value("doc_name", $je_current->doc_name),
  'class'        => "form-control",
  'autocomplete' => "off",
  'type'         => "text",
);
$date = array(
  'name'         => 'date',
  'id'           => 'date',
  'value'        => set_value("date", $je_current->date),
  'class'        => "form-control",
  'autocomplete' => "off",
  'type'         => "text",
);
$journal_name = array(
  'name'         => 'journal_name',
  'id'           => 'journal_name',
  'value'        => set_value("journal_name", $je_current->journal_name),
  'class'        => "form-control",
  'autocomplete' => "off",
  'type'         => "text",
...
$explainations = array(
  'name'         => 'explanations',
  'id'           => 'explanations',
  'value'        => set_value("explanations", $je_current->explanations),
  'class'        => "form-control",
  'autocomplete' => "off",
  'type'         => "text",
...
$amount = array(
  'name'         => 'amount',
  'id'           => 'amount',
  'value'        => set_value("amount", $je_current->amount),
  'class'        => "form-control",
  'autocomplete' => "off",
  'type'         => "text",
...
<?php echo form_open("je_current/edit?id=".$je_current->id, array('class' => 'form-horizontal', 'id'=> 'form_item'));?>
  ...
  <div class="col-md-10 col-md-offset-1">
    ...
    <div class="row form-group">
     ...
     <div class="row form-group">
      ...
      <div class="col-md-9">
        <input id="acc_debt" class="form-control" name="acc_debt" value="<?=$je_current->acc_debt?>" />
      </div>
    </div>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-9">
        <input  name="acc_crdt" id="acc_crdt" class="form-control" value="<?=$je_current->acc_crdt?>" >
      </div>
    </div>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-9">
        ...
        echo form_dropdown('gl_status', $status, set_value("gl_status", $je_current->gl_status), $gl_status);
        ?>
