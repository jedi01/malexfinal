...
<div class="row row-equal" id="payment_details">
  ...
  <div class="col-md-6">
    <div class="row form-group">
      ...
      <div class="col-md-7">
        <p class="form-control-static"><?php echo $purchase_supplier->fullname ?></p>
      </div>
    </div>
    <div class="row form-group">
      <label class="col-md-5 form-control-label"><?php echo lang('purchases');?></label>
      <div class="col-md-7">
  ...
  <hr>
    <div class="row form-group text-xs-center">
      ...
      <p class="form-control-static text-success font-weight-light font-4xl">
          <?php echo formatMoney($payment->amount, $purchase_currency); ?>
      </p>
    </div>
  </div>
</div>
