...
$cash_in = isset($invoice)?$invoice->total_due:"0";
...
<div class="row">
  <div class="col-md-5 col-md-offset-1">
    ...
    <!-- cash_in -->
    <div class="form-group required">
      <?php echo lang('cash_in', 'cash_in', $label_params); ?>
      <div class="input-group">
        <input type="number" step="any" min="0" value="<?php echo set_value("receipt[cash_in]", $cash_in) ?>" name="receipt[cash_in]" class="form-control" id="cash_in" />
  ...
  .easyAutocomplete({
      ...
      list: {
          ...
          onSelectItemEvent: function() {
              ...
              $('input[name="receipt[cash_in]"]').val(Format_float(data.total_due));
              $('input[name="receipt[cash_in]"]').next('.input-group-addon').text(getFormatedCurrency(data.currency));
