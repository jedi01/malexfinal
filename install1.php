...
$base_url  = substr($base_url, 0, strripos($base_url, "/")+1);
  ...
  //junaid
  $_TABLES['accounts'] ="`id` INT NOT NULL AUTO_INCREMENT , 
  ...
  $_TABLES['je_current'] = "`id` INT NOT NULL AUTO_INCREMENT , 
  `doc_name` VARCHAR(225) NOT NULL , 
  `journal_name` VARCHAR(255) NOT NULL , 
  `acc_debt` VARCHAR(255) NOT NULL COMMENT '0 for inactive/1 for active ' , 
  `acc_crdt` VARCHAR(255) NOT NULL , 
  `amount` INT(11) NOT NULL , 
  `explanations` LONGTEXT NOT NULL , 
  `date` VARCHAR(255) NOT NULL ,
  `gl_status` varchar(25) NOT NULL DEFAULT 'open',
   PRIMARY KEY (`id`)";


  $_TABLES['initial_balance'] = "`id` INT NOT NULL AUTO_INCREMENT , 
  `account_number` VARCHAR(225) NOT NULL , 
  `dtp_amount` VARCHAR(255) NOT NULL , 
  `crd_amount` VARCHAR(255) NOT NULL COMMENT '0 for inactive/1 for active ' , 
  `description` LONGTEXT NOT NULL , 
   PRIMARY KEY (`id`)";


  $_TABLES['uom'] = "`id` INT NOT NULL AUTO_INCREMENT , 
  `unit_of_measurement` VARCHAR(225) NOT NULL , 
  `description` VARCHAR(255) NOT NULL , 
  `status` INT(11) NOT NULL DEFAULT '0',
   PRIMARY KEY (`id`)";


$_TABLES['purchase_payment'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  $_TABLES['purchase'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  $_TABLES['purchase_items'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  $_TABLES['receipts_purchase'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  `purchase_id` int(11) NOT NULL,
...
$_TABLES['invoices'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `description` VARCHAR(255) NOT NULL,
  `status` varchar(25) NOT NULL DEFAULT 'Draft',
   `gl_status` varchar(25) NOT NULL DEFAULT 'not_posted',
...
$_TABLES['items'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `tax_type` tinyint(1) NOT NULL DEFAULT '1',
  `tax` decimal(25,4) NOT NULL DEFAULT '0.0000',
  `vat_rate` decimal(25,4) NOT NULL DEFAULT '0.0000',
...
$_TABLES['receipts'] = "`id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `number` int(11) NOT NULL,
  `date` date NOT NULL,
  `cash_in` decimal(10,2) NOT NULL DEFAULT '0.0000',
  `cash_out` decimal(10,2) NOT NULL DEFAULT '0.0000',
  `method` varchar(20) DEFAULT 'cash',
  `details` text NOT NULL,
  `credit_card` text,
  `token` varchar(255) DEFAULT NULL,
...
function updateConfig($updateList)
{
  ...
  else
  {
    ...
    "define('CONFIG_MYSQL_DB', '".addslashes(updateConfigHelper($updateList, 'mysql_db', 'Lynks_db'))."');\n".
...
<?php if ($step == 1): ?>
  <form class="form-login form-horizontal" method="post">
    ...
    <div class="row form-group">
      ...
      <div class="col-md-5">
        <input type="text" name="mysql_db" id="database" class="form-control" value="<?php echo isset($_POST['mysql_db'])?$_POST['mysql_db']:"Lynks_db" ?>" />
      </div>
    </div>
    <hr>
    <div class="text-md-right">
...
<?php if ($step == 4): ?>
  <form class="form-login form-horizontal" method="post">
    ...
    <div class="well well-small">
      Thank you for installing Lynks Bookkeeping  <span class="font-weight-bold">Software</span> System v 1.9.7 <br>
    </div>
    <hr>
    <div class="text-md-right">
